...
function getNextDueDate() {
  let tasksNotDone = tasks
    ...
    .sort((a, b) => new Date(legacyDateToIso(a.dueDate)) - new Date(legacyDateToIso(b.dueDate)));

  if (tasksNotDone.length > 0) {
    let parsedValue = new Date(legacyDateToIso(tasksNotDone[0].dueDate));
    ...
    nextDueDate = "No upcoming deadline";
  }
  return nextDueDate;
}
