        ...
        if (!searchValue || 
            ...
            loaded_contacts[i].name.secondName.toLowerCase().includes(searchValue)) {
                ...
                if (currentUser !== '' && currentUserId !== 999 && ownContact) {
                    if (loaded_contacts[i].name.firstName == ownContact.name.firstName &&
                        loaded_contacts[i].name.secondName == ownContact.name.secondName ||
                        loaded_contacts[i].name.firstName == ownContact.name.firstName &&
